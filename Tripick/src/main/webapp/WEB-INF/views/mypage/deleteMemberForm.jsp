								...
								<fieldset style="width: 100px">
									...
									<ul class="list_find">
										...
										<li style="float: left;">
											...
											<input  type="password" class="form-control" id="userPwd" placeholder="Please Enter Password" name="userPwd" required size=15>
					                        <button type="button" id="passChk" style=15>PW 확인</button>
					                    </li>
										<li id="li_cell">
					                        ...
					                        <div class="wrap_input">
					                           ...
					                           <button type="button" id="emailCer" class="btn_basic2 type03 btn_cert">인증번호 발송</button>
					                        </div>
					                     </li>
									</ul>
								</fieldset>
