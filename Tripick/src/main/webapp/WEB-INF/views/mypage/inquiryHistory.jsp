            ...
            <div id="pagingArea" >
                <ul class="pagination">
                	<c:choose>
                		...
                		<c:otherwise>
                			<li class="page-item"><a class="page-link" href="inquiryhis.my?page=${ pi.currentPage -1 }">&lt;&lt;</a></li>
                		</c:otherwise>
                	</c:choose>
                    
                    
                    <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
                    	<li class="page-item"><a class="page-link" href="inquiryhis.my?page=${ p }">${ p }</a></li>
                    </c:forEach>
