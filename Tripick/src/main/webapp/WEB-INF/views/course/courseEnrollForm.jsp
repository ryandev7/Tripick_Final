...
<style>
    ...
    #AR_plan-searchbox_ul--gray .info {
        float: right;
        width: 220px;
        height: 100%;
        position: absolute;
...
<body>
   ...
   <jsp:include page="../common/header.jsp"/>
	...
	<div class="AR_button-area">
	    ...
	    <button class="AR_button-area_button-close" onclick="location.href='${pageContext.request.contextPath}/planL?id=${member.id}'">닫기</button>
	</div>
